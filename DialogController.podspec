#
#  Be sure to run `pod spec lint DialogController.podspec' to ensure this is a
...
# spec.description  = <<-DESC 这是一个提示框,其用法类似系统的UIAlertController，加入了一些其他的特殊属性。DESC
  ...
  spec.author             = { "张熔冰" => "zhangrongbing@aliyun.com" }
  # Or just: spec.author    = "张熔冰"
  # spec.authors            = { "张熔冰" => "zhangrongbing@aliyun.com" }
  # spec.social_media_url   = "https://twitter.com/张熔冰"
  ...
  spec.source       = { :git => "https://github.com/zhangrongbing/Component.git", :tag => "#{spec.version}" }
